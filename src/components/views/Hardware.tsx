...
import { HardwareValveCard } from './shared/HardwareValveCard';
import { HardwareNanoCard } from './shared/HardwareNanoCard';
import { HardwareSensorCard } from './shared/HardwareSensorCard';
import { HardwareGateCard } from './shared/HardwareGateCard';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.nanos.map(nano => (
               <HardwareNanoCard
                 ...
                 onUpdateNanoConfig={onUpdateNanoConfig!}
                 onSendNanoCommand={onSendNanoCommand!}
                 onRemoveNano={onRemoveNano!}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 max-h-full overflow-y-auto pr-2 pb-4">
              {data.sensors.map(sensor => (
                <HardwareSensorCard
                  ...
                  onToggleSensorEnabled={onToggleSensorEnabled!}
              ...
              <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    <HardwareGateCard
                      gate={data.inputGate}
                      gateKey="inputGate"
                      title="Giriş Kapısı Motoru"
                      data={data}
                      onUpdateSystemGate={onUpdateSystemGate}
                      onToggleGateEnabled={onToggleGateEnabled}
                    />
                    <HardwareGateCard
                      gate={data.outputGate}
                      gateKey="outputGate"
                      title="Çıkış Kapısı Motoru"
                      data={data}
                      onUpdateSystemGate={onUpdateSystemGate}
                      onToggleGateEnabled={onToggleGateEnabled}
                    />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 max-h-full overflow-y-auto pr-2 pb-4">
              {data.valves.map(valve => (
                <HardwareValveCard
                  ...
                  valve={valve}
                  data={data}
                  editingValveId={editingValveId}
                  tempValveName={tempValveName}
                  setEditingValveId={setEditingValveId}
                  setTempValveName={setTempValveName}
                  onUpdateValve={onUpdateValve}
                  onToggleHardwareStatus={onToggleHardwareStatus}
